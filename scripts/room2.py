...
# Constants
NUM_RENDERS = 75
OUTPUT_DIR = 'D:/Polytech/5A/TAI/output/Second Batch/bedroom_blue_sofa_change_color_desk_closet'
...
for render_count in range(NUM_RENDERS):
    ...
    if closet_obj:
        ...
        print(random_color)
        change_object_color(closet_obj, random_color)     
    if desk_obj:
        random_color = generate_random_color()
        print(random_color)
        change_object_color(desk_obj, random_color)
